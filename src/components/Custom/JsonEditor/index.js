                ...
                <div className="dropdown_type">
                  {boolean.map((d, i) => (
                    <p
                      ...
                      key={i}
                      onClick={() =>
                        changeBoolean(d.value, index) + setVisibleBoolean(false)
                      }
                    >
                      {d.label}
                    </p>
      ...
      case "boolean":
        return (
          <select
            ...
            onChange={(e) =>
              setCreate({ ...create, value: String(e.target.value) })
            }
          >
    ...
    <ErrorBoundary>
      <div className="col-12 cr-pointer">
        ...
        >
          ...
          >
            {getLinesCount().map((item, i) => (
              <div key={i} style={{ color: "#AAA0A0", marginTop: 10 }}>
                {item}
              </div>
            ))}
          </div>
          ...
          <div className="react-json_editor py-2">
            <div
              className="d-flex editor-line _jc-between"
            ...
            >
              ...
              <div className="d-flex">
                <div
                  className="d-flex _center"
                  onClick={() => setNewLineExample(true)}
                >
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="d-flex _center a-r__buttons">
                                  ...
                                  <i
                                    ...
                                    onDoubleClick={(e) =>
                                      e.stopPropagation() + setNewLine(false)
                                    }
                              ...
                              {item.type === "object" && (
                                <div
                                  ...
                                  className="editor-line _jc-between"
                                  onDoubleClick={() => getOneNewLine(index)}
                                >
                                  {item.type === "object" && "}"}
                                  <div className="d-flex _center a-r__buttons">
                                    <i
                              ...
                              {oneNewLine === index && (
                                <form
                                  onSubmit={(e) => createNewOneItem(e, index)}
                                  ref={formRef}
  ...
  return (
    <ErrorBoundary>
      <div className="ml-3">
        {newLineExample && (
          <form
            onSubmit={(e) => createExampleLine(e)}
            ref={formRef}
            className="static__width"
          >
            <div className="px-5 d-flex">
              ...
              >
                <option value="" disabled={create.type !== ""}>
                  Type
                </option>
                {types?.map((d, i) => (
                  <option key={i} value={d.value}>
              ...
              <button
                className="btn badge-x_btn"
                onClick={() => setNewLineExample(false)}
              >
                x
              </button>
            </div>
    ...
    <ErrorBoundary>
      <input
        className={`is_required text-light ${
          state.data.parameters[index].is_required ? "active" : ""
        }`}
        type="checkbox"
        onChange={(e) =>
      ...
      {edit === index ? (
        ...
        <div onClick={() => setEdit(index)}>"field":</div>
      ) : (
