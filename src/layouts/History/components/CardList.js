...
export const CardList = ({ state, setState, name }) => {
  ...
  const loadEmail = async () => {
    let response = await historyEmailtotal({
      ...
      target_type: state.filters.target_type || "",
      template_id: state.filters.template_id || ""
  ...
  useEffect(() => {
    loadEmail();
  }, [state.title, state.filters.range, state.filters.archived, state.filters.target_type, state.filters.template_id]);
          ...
          <div className="card-body py-3 px-3">
            <div className="w-100 d-flex justify-content-between align-items-center">
              ...
              >
                ...
                >
                  <path
                    d="M33 18H24L21 22.5H15L12 18H3"
                    stroke="#AB77E8"
                    strokeWidth="3"
                    strokeLinecap="round"
                  ...
                  ></path>
                  <path
                    d="M8.175 7.665L3 18V27C3 27.7956 3.31607 28.5587
              ...
              <div className="d-flex flex-column align-items-end">
                <div className="fs-18">{state.emailTotal?.count}</div>
                <span className="fs-13 text-muted">Total Emails</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="card-body py-3 px-3">
            <div className="w-100 d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex flex-column align-items-end">
                <div className="fs-18">{state.emailTotal?.opened}</div>
                <span className="fs-13 text-muted">Opened</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="card-body py-3 px-3">
            <div className="w-100 d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex flex-column align-items-end">
                <div className="fs-18">{state.emailTotal?.delivered}</div>
                <span className="fs-13 text-muted">Delivered</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="card-body py-3 px-3">
            <div className="w-100 d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex flex-column align-items-end">
                <div className="fs-18">{state.emailTotal?.not_delivered}</div>
                <span className="fs-13 text-muted">Not Delivered</span>
              </div>
            </div>
          </div>
        </div>
