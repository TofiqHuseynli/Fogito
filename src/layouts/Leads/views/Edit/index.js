...
import { ErrorBoundary, Lang, Popup, Loading, useToast } from "fogito-core-ui";
        ...
        header={
          <div className="d-flex justify-content-between align-items-center w-100">
            ...
            <h5 className="title fs-16">
              {Lang.get("Create")} {Lang.get(match?.params?.type)}
            </h5>
            <div>
