          ...
          <div style={{ minHeight: 500 }}>
            <div className="row">
              <div className="col-md-8 px-2 mt-1">
                <label>
                  {Lang.get("Title")}
                  <span className="text-danger fs-18 ml-1">*</span>
                </label>
                <input
              ...
              <div className="col-md-4 px-2 mt-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setState({
                      ...state,
                      data: { ...state.data, status: parseInt(e.target.value) },
                    })
                  }
                >
              ...
              <div className="col-md-8 px-2 mt-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setState({
                      ...state,
                      data: { ...state.data, slug: e.target.value },
                    })
                  }
                />
              </div>
              <div className="col-md-4 px-2 mt-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setState({
                      ...state,
                      data: { ...state.data, public: parseInt(e.target.value) },
                    })
                  }
                >
                  <option value="" selected="">
                  ...
                  {state.public_data.map((item, key) => (
                    <option
                      value={item.value}
                      key={key}
                      selected={item.value === state.data.public?.value}
                    >
                      {Lang.get(item.label)}
                    </option>
                  ))}
