...
import {
    ...
    scheduleList, minList, usersSearch, groupsMinList, templateMinList,
    timezones, scheduleCreate, snippetsParameter, infoSchedule, scheduleEdit
} from "@actions";
...
export const Edit = ({ onClose, reload, match }) => {
    ...
    const onSubmit = async () => {
        ...
        let response = await scheduleEdit({
            id: state.id,
            target_type_id: state.target_type.value,
            lead_id: state.lead.value,
            ...
            repeat: state.repeatCheck ? state.repeat : {},
    ...
    const loadData = async () => {
        ...
        let response = await infoSchedule({ id: state.id });
            ...
            <Popup
                ...
                <div style={{ minHeight: 400 }}>
                    ...
                    <div className="row  px-2 py-3 mb-3 rounded border border-light">
                        ...
                        <div className='col-lg-6 mb-4 col-md-12'>
                            ...
                            <div className='input-group input-group-alternative'>
                                <Select
                                    ...
                                    value={targetTypeList.find((type) => type.value == state.target_type.value)}
                                    className='form-control form-control-alternative'
                                    placeholder={Lang.get("Select")}
                                    onChange={(type) => {
                                        setState({ target_type: type });
                                        historyPushByName(
                                            {
                                                label: "type",
                        ...
                        {/*Gender*/}
                        {(state.target_type.value == 3 || state.target_type.value == 4) && (
                            <div className="col-lg-6 mb-4 col-md-12">
                                <label className='text-muted mb-1'>
                                    {Lang.get("Gender")}
                                </label>
                                    ...
                                    <div className="form-group col-md-6 col-12">
                                        ...
                                        <div className='input-group input-group-alternative'>
                                            <Select
                                                ...
                                                value={endList.find((type) => type.value == state.repeat.end.type)}
                                                className='form-control form-control-alternative'
                                                placeholder={Lang.get("Select")}
                                                onChange={(type) => {
                                                    setState({
